...
func TestWriteImage(t *testing.T) {
	...
	t.Run("errorGeneratingScaledImages", func(t *testing.T) {
		...
		_, err := WriteImage("aprefix", filePath, "abucket", bytes.NewBuffer(sampleBuf))
		assert.NotNil(t, err)
